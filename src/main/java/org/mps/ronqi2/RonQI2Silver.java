...
public class RonQI2Silver extends RonQI2{
    ...
    */
    public void obtenerNuevaLectura(){
        ...
        // ERROR 1:
        // LLAMABA DOS VECES A LEER SENSOR PRESION
    ...
    */
    ...
    public boolean evaluarApneaSuenyo() {
        ...
        Double avgS = lecturasS.stream()
                ...
                .average()
                .orElse(0.0);
        // ERROR 2: avgP DEBE SER ESTRICTAMENTE SUPERIOR AL LIMITE, NO IGUAL.
        // ERROR 3: EN CASO DE SER SUPERIOR DEBE DEVOLVER TRUE. 
